...
│           └── V13__seed_demo_data.sql                          ← pendiente, Hito 41 (única migración que falta)
│
...
- [ ] `Flyway V13` — seed datos demo realistas (5 vehículos, 3 conductores, 10 trabajos completados, 3 facturas de cliente, facturas de proveedor de ejemplo)
